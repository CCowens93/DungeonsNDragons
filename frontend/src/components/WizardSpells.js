...
class WizardSpells extends Component{
        ...
        cantrip = [
              ...
              },
              {
                ...
                components:'V, S',
                duration:'1 minute',
                effect:"A spectral, floating hand appears at a point you choose within range. The hand lasts for the duration or until you dismiss it as an action. The hand vanishes if it is ever more than 30 feet away form you or if you cast this spell again. You can use your action to control the hand. You can use the hand to manipulate an object, open an unlocked door or container, stow or retrieve an item from an open container, or pour the contents out of a vial. You can move the hand up to 30 feet each time you use it. The hand can't attack, activate magic items, or carry more than 10 pounds.",
                damage:"None"
              },
                {
                 name:'Mending',
               ...
               },
                {
                  ...
                  effect:"You extend your hand and point a finger at a target in range. Your magic grants you a brief insight into the target's defenses. On you next turn, you gain advantage on your first attack the target, provided that this spell hasn't ended.",
                  damage:"None"
                },
        ]
     ...
     const cantripTable = this.cantrip.map((cantrip, i) => (
                 <tr key={i}>
                     <td>{cantrip.name}</td>
                     <td>{cantrip.type}</td>
                     <td>{cantrip.castingTime}</td>
                     <td>{cantrip.range}</td>
                     <td>{cantrip.components}</td>
                     <td>{cantrip.duration}</td>
                     <td width={500}>{cantrip.effect}</td>
                     <td width={500}>{cantrip.damage}</td>
                 </tr>
))
